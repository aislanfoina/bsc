...
/* Define to 1 if the system has the type `long float'. */
/* #undef HAVE_LONG_FLOAT */
...
/* Name of package */
#define PACKAGE "ClusteringSuite"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "tools@bsc.es"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ClusteringSuite"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ClusteringSuite 1.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "clusteringsuite"
