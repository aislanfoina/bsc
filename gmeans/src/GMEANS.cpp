...
GMEANS::GMEANS(map<string, string> ClusteringParameters) {
	...
	if (ParametersIterator == ClusteringParameters.end()) {
		string ErrorMessage;
		ErrorMessage = "parameter '" + GMEANS::INITIAL_POINTS
				+ "' not found in G-Means definition";
		...
		if (*err) {
			string ErrorMessage;
			ErrorMessage = "incorrect value for G-Means parameter '"
					+ GMEANS::INITIAL_POINTS + "'";
	...
	if (ParametersIterator == ClusteringParameters.end()) {
		string ErrorMessage;
		ErrorMessage = "parameter '" + GMEANS::CRITICAL_VALUE
				+ "' not found in G-Means definition";
